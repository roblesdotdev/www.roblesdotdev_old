      ...
      <div className="relative mx-auto h-full max-w-xl py-12 px-6 md:max-w-2xl lg:max-w-4xl ">
        <div className="flex flex-col gap-4">
          ...
          {action ? (
            <button
              onClick={action}
              className="mt-6 self-start rounded-md border-2 border-fg px-12 py-4 text-sm font-medium text-fg"
            >
  ...
  return (
    <ErrorPage
      errorProps={{
        ...
        subtitle: `"${pathname}" is not a page on roblesdotdev site. So sorry.`,
      }}
